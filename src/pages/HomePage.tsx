...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-fin-light dark:bg-fin-dark text-slate-800 dark:text-slate-100 flex flex-col items-center justify-center p-6 transition-colors duration-500 relative overflow-hidden">
      ...
      <div className="max-w-md w-full backdrop-blur-md bg-white/90 dark:bg-fin-card/90 rounded-[2.5rem] shadow-2xl p-10 text-center border border-white/20 dark:border-slate-700/50 transform transition-all hover:shadow-emerald-500/5">
        ...
        {/* Aksiyon Butonu */}
        <button className="group relative w-full overflow-hidden rounded-2xl bg-emerald-600 dark:bg-emerald-500 px-8 py-4 text-white transition-all duration-300 hover:bg-emerald-700 hover:shadow-xl active:scale-95 shadow-lg shadow-emerald-500/20">
